  ...
  render () {
    let showForm
      if (this.state.displayForm) {
        ...
        <QuestVote currentGame= {this.props.currentGame} currentQuest={this.props.currentQuest} currentUser={this.props.currentUser} users={this.props.users} members={this.state.members}/>
      }
    return (
